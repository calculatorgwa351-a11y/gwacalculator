      ...
      >
        <div class="flex items-center gap-3">
          ...
          <div class="min-w-0">
            ...
            <div class="text-xs text-slate-500 dark:text-slate-300 font-black uppercase tracking-[0.16em] truncate">
              {{ authStore.user.school_id }}
            </div>
          </div>
        </div>
        <div class="mt-3 flex flex-wrap gap-2">
          <span v-if="authStore.user.department" class="px-2 py-1 rounded-full bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 text-xs font-black uppercase tracking-[0.16em] text-slate-600 dark:text-slate-200">
            {{ authStore.user.department }}
          </span>
          <span v-if="authStore.user.course" class="px-2 py-1 rounded-full bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 text-xs font-black uppercase tracking-[0.16em] text-slate-600 dark:text-slate-200">
